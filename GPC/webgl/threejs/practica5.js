...
function loadScene() {
    //Texturas
    var path = "images/";
    var txSuelo = new THREE.TextureLoader().load(path + "pisometal_1024x1024.jpg");
    ...
    var txRobot = new THREE.TextureLoader().load(path + "metal_128.jpg");
    
    //Carga la escena
    var matRotula = new THREE.MeshPhongMaterial({color:'white', specular:0x99BBFF,shininess:50, envMap:mapaEntorno});
    
    var matRobot = new THREE.MeshLambertMaterial({color:'white', wireframe: false, map: txRobot});
    ...
    var matMano = new THREE.MeshPhongMaterial({color:'red', specular:0x99BBFF,shininess:50, map:txRobot});
    ...
    mano = new THREE.Mesh(geoMano, matMano);
    ...
    var habitacion = new THREE.Mesh(new THREE.BoxGeometry(3000,3000,3000), matParedes);
